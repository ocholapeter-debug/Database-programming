...
SELECT full_name,occupation,village_section
FROM residents
WHERE gender='Female'; 
...
SELECT full_name,occupation 
FROM residents
WHERE is_head_of_household=true OR occupation='Unemployed' ;


SELECT full_name,date_of_birth,village_section
FROM residents
WHERE EXTRACT (YEAR FROM date_of_birth) AND village_section='Kiwatule Central';
